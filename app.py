...
<p style="margin-top:25px; font-size:14px; font-weight:bold;">
  ...
  <a href="mailto:scott@londonbusinessaward.com" style="color:#D7262F; font-weight:bold;">scott@londonbusinessaward.com</a><br/>
  (+44) 2034517166
</p>
...
def send_email(sender_email, sender_password, row, subject, custom_html):
    try:
        server = smtplib.SMTP("mail.londonbusinessaward.com", 587)
        server.starttls()
        ...
        try:
            imap = imaplib.IMAP4_SSL("mail.londonbusinessaward.com")
...
sender_email = st.text_input("Sender Email", value="scott@londonbusinessaward.com")
